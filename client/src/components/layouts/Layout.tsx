        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <div className="bg-white rounded-xl shadow-md overflow-hidden border border-gray-200 hover:shadow-lg transition">
            ...
            <div className="p-5">
              ...
              <div className="flex items-center justify-between">
                <span className="text-2xl font-bold text-blue-900">$45 <span className="text-sm font-normal text-gray-500">/day</span></span>
                <Link
                  to="/fleet/1"
          ...
          <div className="bg-white rounded-xl shadow-md overflow-hidden border border-gray-200 hover:shadow-lg transition">
            ...
            <div className="p-5">
              ...
              <div className="flex items-center justify-between">
                <span className="text-2xl font-bold text-blue-900">$75 <span className="text-sm font-normal text-gray-500">/day</span></span>
                <Link
                  to="/fleet/2"
                  className="bg-blue-900 hover:bg-blue-800 text-white px-4 py-2 rounded-lg text-sm font-medium transition"
                >
          ...
          <div className="bg-white rounded-xl shadow-md overflow-hidden border-2 border-amber-400 hover:shadow-lg transition relative">
            ...
            <div className="p-5">
              ...
              <div className="flex items-center justify-between">
                <span className="text-2xl font-bold text-blue-900">$89 <span className="text-sm font-normal text-gray-500">/day</span></span>
                <Link
                  to="/fleet/3"
                  className="bg-blue-900 hover:bg-blue-800 text-white px-4 py-2 rounded-lg text-sm font-medium transition"
                >
